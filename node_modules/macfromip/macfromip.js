...
macfromip.getMacInLinux = function(ipAddress, callback){
  ...
  var ls = cp.exec('ping  -c 1 ' + ipAddress,
    function(error, stdout, stderr) {
      if (error !== null) {
        console.log('IP address unreachable', 'exec error: ' + error);
        //return;
      }
      if (stderr !== null && stderr !== '') {
        console.log('IP address unreachable', 'stderr: ' + stderr);
        //return;
      }
      ...
      var ls2 = cp.exec('arp -a',
        function(error2, stdout2, stderr2) {
          if (error2 !== null) {
            console.log('IP address unreachable', 'exec error: ' + error2);
            //return;
          }
          if (stderr2 !== null && stderr2 !== '') {
            console.log('IP address unreachable', 'stderr: ' + stderr2);
            //return;
          }
